      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
            ...
            <Text style={styles.cardContent}>{new Date(item.start_date).getMonth() + 1}</Text>
            ...
            <Text style={styles.cardContent}>{item.total_elevation_gain} m</Text>

            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Actividades mensuales', {month: new Date(item.start_date).getMonth() + 1, })}>
